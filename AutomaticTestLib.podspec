...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AutomaticTestLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wei/AutomaticTestLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wei' => '641462576@qq.com' }
  s.source           = { :git => 'https://github.com/wei/AutomaticTestLib.git', :tag => s.version.to_s }
